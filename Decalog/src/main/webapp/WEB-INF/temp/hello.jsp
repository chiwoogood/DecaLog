...
<html>
	<head>
		...
		<link rel="stylesheet" href="${capth}/css/main.css" />
...
&lt;/div&gt;</code></pre>
		...
		<!-- Scripts -->
			<script src="${cpath}/js/jquerymin.js"></script>
			<script src="${cpath}/js/jqueryscrollex.min.js"></script>
			<script src="${cpath}/js/jqueryscrolly.min.js"></script>
			<script src="${cpath}/js/browsermin.js"></script>
			<script src="${cpath}/js/breakpointsmin.js"></script>
			<script src="${cpath}/js/util.js"></script>
			<script src="${cpath}/js/main.js"></script>

		<!-- Note: Only needed for demo purposes. Delete for production sites. -->
			<script src="${cpath}/js/demo.js"></script>
