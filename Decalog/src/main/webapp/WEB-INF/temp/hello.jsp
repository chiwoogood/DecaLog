...
&lt;/div&gt;</code></pre>
		...
		<!-- Scripts -->
			<script src="${cpath}/resources/js/jquerymin.js"></script>
			<script src="${cpath}/resources/js/browsermin.js"></script>
			<script src="${cpath}/resources/js/breakpointsmin.js"></script>
